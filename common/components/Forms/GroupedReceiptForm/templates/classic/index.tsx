  ...
  >
    <div className={cs.providerInfo}>
      ...
      <pre className={cs.preLabel}>
        {(data?.domain?.nameForInvoices || data?.domain?.name) && <><strong>{data.domain.nameForInvoices || data.domain.name}</strong>{'\n'}</>}
    ...
    <div className={cs.receiverInfo}>
      ...
      <pre className={cs.preLabel}>
        {(data?.reciever?.nameForInvoices || data?.reciever?.companyName) && (
          <><strong>{data.reciever.nameForInvoices || data.reciever.companyName}</strong>{'\n'}</>
        )}
