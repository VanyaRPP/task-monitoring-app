          ...
          return (
            <Tag
              ...
              className={`${s['icon-btn']} ${
                item.customClass ? s[item.customClass] : ''
              } ${item.label === 'Контакти' ? s.ContactButton : ''}`}
              aria-label={item.label}
              onClick={() => handleClick(item.label)}
            >
              <span
                className={s['icon-btn__back']}
            ...
            >
              ...
              <p>
                ...
                >
                  <HomeOutlined
                    ...
                    className={s.ContactAdressGoogle}
                  />
              ...
              <p>
                <span
                  ...
                  onClick={() =>
                    navigator.clipboard.writeText('mail@spacehub.in.ua')
                  }
                  style={{
                    cursor: 'pointer',
                    display: 'flex',
              ...
              <p>
                <span
                  onClick={() =>
                    navigator.clipboard.writeText('+38(073)-777-5242')
                  }
                  style={{
                    cursor: 'pointer',
                    display: 'flex',
