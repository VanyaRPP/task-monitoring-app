...
describe('getInvoices - WATER', () => {
  describe('props: { service }', () => {
    ...
    it('should NOT load when service = { waterPrice: 10 }', () => {
    ...
    it('should NOT load when service = { waterPrice: 0 }', () => {
      const service: Partial<IService> = {
        waterPrice: 0,
      }
    ...
    it('should NOT load when service = { waterPrice: null }', () => {
      const service: Partial<IService> = {
        waterPrice: null,
      }
  ...
  describe('props: { service, company }', () => {
    ...
    it('should NOT load when service = { waterPrice: 10 }, company = { waterPart: 10 }', () => {
      const service: Partial<IService> = {
        waterPrice: 10,
      }
      const company: Partial<IRealestate> = {
    ...
    it('should NOT load when service = { waterPrice: 10 }, company = null', () => {
      const service: Partial<IService> = {
        waterPrice: 10,
      }
      const company: Partial<IRealestate> = null
    ...
    it('should load when service = { waterPrice: 0 }, company = { waterPart: 0 }', () => {
      const service: Partial<IService> = {
        waterPrice: 0,
      }
      const company: Partial<IRealestate> = {
    ...
    it('should load when service = { waterPrice: 10 }, company = { ... }', () => {
      const service: Partial<IService> = {
        waterPrice: 10,
      }
      const company: Partial<IRealestate> = {
    ...
    it('should load when service = { waterPrice: 10 }, company = { waterPart: 0 }', () => {
      const service: Partial<IService> = {
        waterPrice: 10,
      }
      const company: Partial<IRealestate> = {
    ...
    it('should load when service = { waterPrice: 10 }, company = { waterPart: null }', () => {
      const service: Partial<IService> = {
        waterPrice: 10,
      }
      const company: Partial<IRealestate> = {
    ...
    it('should load when service = { waterPrice: 10 }, company = { waterPart: undefined }', () => {
      const service: Partial<IService> = {
        waterPrice: 10,
      }
      const company: Partial<IRealestate> = {
  ...
  describe('props: { service, company, prevPayment }', () => {
    ...
    it('should NOT load when service = { waterPrice: 10 }, company = null, prevPayment = { invoice: [Water] }', () => {
      const service: Partial<IService> = {
        waterPrice: 10,
      }
      const company: Partial<IRealestate> = null
    ...
    it('should NOT load when service = { waterPrice: 10 }, company = { waterPart: 10 }, prevPayment = { invoice: [Water] }', () => {
      const service: Partial<IService> = {
        waterPrice: 10,
      }
      const company: Partial<IRealestate> = {
    ...
    it('should NOT load when service = { waterPrice: 10 }, company = { waterPart: 10 }, prevPayment = { invoice: [Electricity] }', () => {
      const service: Partial<IService> = {
        waterPrice: 10,
      }
      const company: Partial<IRealestate> = {
    ...
    it('should load when service = { waterPrice: 10 }, company = { ... }, prevPayment = { invoice: [Water] }', () => {
      const service: Partial<IService> = {
        waterPrice: 10,
      }
      const company: Partial<IRealestate> = {
  ...
  describe('props: { service, company, payment } with prio to payment', () => {
    ...
    it('should load when service = null, company = null, payment = { invoice: [Water] }', () => {
      const service: Partial<IService> = null
      const company: Partial<IRealestate> = null
      const payment: Partial<IPayment> = {
        invoice: [
    ...
    it('should load when service = { waterPrice: 10 }, company = null, payment = { invoice: [Water] }', () => {
      const service: Partial<IService> = {
        waterPrice: 10,
      }
      const company: Partial<IRealestate> = null
    ...
    it('should load when service = null, company = { waterPart: 10 }, payment = { invoice: [Water] }', () => {
      const service: Partial<IService> = null
      const company: Partial<IRealestate> = {
        waterPart: 10,
      }
    ...
    it('should load when service = { waterPrice: 10 }, company = { waterPart: 10 }, payment = { invoice: [Water] }', () => {
      const service: Partial<IService> = {
        waterPrice: 10,
      }
      const company: Partial<IRealestate> = {
    ...
    it('should load when service = { waterPrice: 10 }, company = null, payment = { invoice: [Water, WaterPart] }', () => {
      const service: Partial<IService> = {
        waterPrice: 10,
      }
      const company: Partial<IRealestate> = null
    ...
    it('should load when service = { waterPrice: 10 }, company = { waterPart: 10 }, payment = { invoice: [Water, WaterPart] }', () => {
      const service: Partial<IService> = {
        waterPrice: 10,
      }
      const company: Partial<IRealestate> = {
  ...
  describe('props: { service, company, payment } with customServices', () => {
    it('should NOT load when service = { customServices.waterPrice: undefined }, company = { waterPart: 10 }, payment = { invoice: [Water] }', () => {
      const service: Partial<IService> = {
        customServices: [
          {
            label: 'Water',
    ...
    it('should NOT load when service = { customServices.waterPrice: null }, company = { waterPart: 10 }, payment = { invoice: [Water] }', () => {
      const service: Partial<IService> = {
        customServices: [
          {
            label: 'Water',
    ...
    it('should load when service = { customServices.waterPrice: 0 }, company = { waterPart: 10 }, payment = { invoice: [Water] }', () => {
      const service: Partial<IService> = {
        customServices: [
          {
            label: 'Water',
    ...
    it('should load when service = { customServices.waterPrice: 10 }, company = { waterPart: 10 }, payment = { invoice: [Water] }', () => {
      const service: Partial<IService> = {
        customServices: [
          {
            label: 'Water',
